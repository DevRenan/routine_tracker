...
class Fitness::WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fitness_workout" do
    assert_difference("Fitness::Workout.count") do
      post fitness_workouts_url, params: { fitness_workout: { description: @fitness_workout.description, name: @fitness_workout.name } }
    end
  ...
  test "should update fitness_workout" do
    patch fitness_workout_url(@fitness_workout), params: { fitness_workout: { description: @fitness_workout.description, name: @fitness_workout.name } }
